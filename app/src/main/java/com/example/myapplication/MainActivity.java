...
//        bottomNavigation.add(new MeowBottomNavigation.Model(2, R.drawable.ic_auto));
        bottomNavigation.add(new MeowBottomNavigation.Model(2, R.drawable.ic_action));
        bottomNavigation.add(new MeowBottomNavigation.Model(3, R.drawable.ic_consume));
        bottomNavigation.add(new MeowBottomNavigation.Model(4, R.drawable.ic_solar));
